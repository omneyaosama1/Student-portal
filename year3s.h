...
namespace Project3 {
	...
	/// </summary>
	public ref class year3s : public System::Windows::Forms::Form
	{
	public:
		year3s(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox1->TextChanged += gcnew System::EventHandler(this, &year3s::richTextBox1_TextChanged);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &year3s::button1_Click);
			// 
			// year1_Rs
			// 
